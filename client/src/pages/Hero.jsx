        ...
        <div className="rounded-xl border-gray-800 border-2">
          ...
          <div className="xl:h-[600px] flex md:w-full">
            ...
            <div className="flex flex-1 text-white flex-col custom-gradient sm:p-8">
              <div className="flex  items-center mb-5">
                <div className="flex items-center justify-between w-full">
                  <div className="flex gap-5 items-center ">
                    <h1 className="md:text-2xl md:font-semibold">Workspace</h1>
              ...
              <div className="flex p-5 sm:p-3 justify-between items-center mb-5">
                <div className="">
              ...
              <TabsHeroSection></TabsHeroSection>

              <div className="text-black ">
                <HeroBoardView></HeroBoardView>
              </div>
            </div>
          </div>
        </div>
